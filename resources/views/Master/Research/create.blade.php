                    ...
                    <div class="card-body">
                        <div class="">
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form class="form-material" method="POST" action="{{ url('/cms/res_static_save') }}"
                                            ...
                                            <div class='form-group form-default'>
                                                ...
                                                <div class="form-group ">
                                                    <label class="float-label">Research Articles
                                                        Heading</label>
                                                    <input name="res_article_heading" value="{{ old('res_article_heading') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subheading_1" value="{{ old('res_article_subheading_1') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subdesc_1" value="{{ old('res_article_subdesc_1') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subheading_2" value="{{ old('res_article_subheading_2') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subdesc_2" value="{{ old('res_article_subdesc_2') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subheading_3" value="{{ old('res_article_subheading_3') }}"
                                                        class="form-control">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input name="res_article_subdesc_3" value="{{ old('res_article_subdesc_3') }}"
                                                        class="form-control">
                                                ...
                                                <div class="d-flex justify-content-centre">
                                                    <div class="col-11 align-items-centre">
                                                        <a href="{{ url('/cms/res_static') }}" class="btn btn-danger">Back</a>
                                                    </div>
